                ...
                <div className="container">
                    <div className="signup-content">
                        <div className="signup-form">
                            <h2 className="form-title">Service</h2>
                            <p className='pb-3'>Here, you can change the service of your car to available or unavailable</p>
                            <form method="POST" className="register-form" id="register-form"></form>
                            <select class="form-control select2 select2-hidden-accessible  border" style={{width: '100%'}} tabindex="-1" 
                        ...
                        <div className="signup-image">
                            <figure><img src={serviceImg} alt="sing up image" /></figure>
                        </div>
                    </div>
                </div>
            </section> 
